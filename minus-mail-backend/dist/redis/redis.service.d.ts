...
export declare class RedisService implements OnModuleInit {
    ...
    storeEmail(username: string, emailData: EmailData): Promise<string>;
    getEmail(emailId: string): Promise<EmailData | null>;
    getEmailIds(username: string): Promise<string[]>;
    getEmailsForUsername(username: string): Promise<EmailData[]>;
    getEmailCount(username: string): Promise<number>;
    removeEmail(username: string, emailId: string): Promise<void>;
    cleanupExpiredEmails(username: string): Promise<void>;
    ping(): Promise<string>;
    ...
    setEmail(emailId: string, data: any, ttlSeconds?: number): Promise<void>;
    addEmailToList(emailId: string, emailData: any): Promise<void>;
    getEmailList(emailId: string): Promise<any[]>;
    getEmailListLength(emailId: string): Promise<number>;
    removeEmailFromList(emailId: string, emailData: any): Promise<void>;
    createSubscriber(): import("@redis/client").RedisClientType<{
        json: {
            ARRAPPEND: {
